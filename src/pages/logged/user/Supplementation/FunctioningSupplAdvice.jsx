...
const FunctioningSupplAdvice = ({ onChangeContent }) => {
  ...
  setCookie("currentPageCookie", "functioning-suppl-advice", {
    path: "/",
  });
  ...
  const fetchIssues = () => {
    axios
      .get(`/api/SupplFuncDiagnosticQuestions/GetFuncSupplAdvice/${userId}`)
      .then((response) => {
  ...
  const saveAsPDF = async () => {
    ...
    doc.save("Porada_Suplementacyjna_Funkcjonowanie.pdf");
  };
  ...
  return (
    <Box flex={12} p={2} sx={{ height: "300vh" }}>
      ...
      <Typography variant="h5" sx={{ textAlign: "center", marginBottom: 3 }}>
        <b>Porada Suplementacyjna - Funkcjonowanie</b>
      </Typography>
...
export default FunctioningSupplAdvice;
