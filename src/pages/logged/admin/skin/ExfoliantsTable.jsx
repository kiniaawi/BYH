...
const ExfoliantsTable = () => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(`/api/Exfoliants/UpdateExfoliant/${editProduct.Id}`, data)
      .then((response) => {
        fetchExfoliants();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/Exfoliants/RevExfoliant/${selectedProduct}`)
      .then((response) => {
        console.log(selectedProduct);
      })
      .catch((error) => {
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/Exfoliants/DelExfoliant/${selectedProduct}`)
      .then((response) => {
        console.log(selectedProduct);
      })
      .catch((error) => {
            ...
            <Card>
              <CardContent>
                <Typography sx={{ textAlign: "center" }}>
                  Are you sure you want to delete this Exfoliant?
                </Typography>
                <Box
                  sx={{
                    textAlign: "center",
        ...
        >
          <Grid container spacing={2}>
            <Card>
              <CardContent>
                <Typography>
                  Are you sure you want to revert this Exfoliant?
                </Typography>
                <Box
                  sx={{
                    textAlign: "center",
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
            ...
            <CardContent>
              <Box>
                <Typography variant="h6" textAlign={"center"} marginBottom={1}>
                  <b>Exfoliants Table</b>
                </Typography>
              </Box>
              <div style={{ height: "80vh" }}>
                <DataGrid
                  columns={ExfoliantsColumns}
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>No Exfolianst Found in the Database</Typography>
          </Box>
        )}
      </div>
    </Box>
...
export default ExfoliantsTable;
