...
const BodyActivesTable = () => {
  ...
  const handleAddFile = () => {
    ...
    axios
      .post("/api/BodyActives/SaveFile", formData)
      .then((response) => {
        alert(response);
      })
      .catch((error) => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(`/api/BodyActives/UpdateBodyActive/${editProduct.Id}`, data)
      .then((response) => {
        fetchProducts();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/BodyActives/RevBodyActive/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/BodyActives/DelBodyActive/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
            ...
            <CardContent>
              <Box>
                <Typography variant="h6" textAlign={"center"} marginBottom={1}>
                  <b>Tabela Składników Aktywnych</b>
                </Typography>
              </Box>
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>
              Nie Znaleziono Składników Aktywnych w Bazie Danych
            </Typography>
          </Box>
        )}
      </div>
...
export default BodyActivesTable;
