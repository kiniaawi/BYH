...
const BodyExfoliantsTable = () => {
  ...
  const handleAddFile = () => {
    ...
    axios
      .post("/api/BodyExfoliants/SaveFile", formData)
      .then((response) => {
        alert(response);
      })
      .catch((error) => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(`/api/BodyExfoliants/UpdateBodyExfoliant/${editProduct.Id}`, data)
      .then((response) => {
        fetchProducts();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/BodyExfoliants/RevBodyExfoliant/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/BodyExfoliants/DelBodyExfoliant/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
          ...
          <Grid container spacing={2}>
            <Card>
              <Typography variant="h5" sx={{ textAlign: "center", p: 3 }}>
                <b>Edytuj Produkt Złuszczający</b>
              </Typography>
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
            ...
            <CardContent>
              <Box>
                <Typography variant="h6" textAlign={"center"} marginBottom={1}>
                  <b>Tabela Produktów Złuszczających</b>
                </Typography>
              </Box>
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>
              Nie Znaleziono Produktów Złuszczających w Bazie Danych
            </Typography>
          </Box>
        )}
      </div>
...
export default BodyExfoliantsTable;
