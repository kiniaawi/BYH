...
import BodyActivesTable from "./BodyActivesTable";

const BodyActives = ({ onChangeContent }) => {
  const [cookies, setCookie, removeCookie] = useCookies([
    "emailCookie",
    "currentPageCookie",
  ]);
  setCookie("currentPageCookie", "body-actives", { path: "/" });
  ...
  return (
    <Box p={2} sx={{ height: "300vh" }}>
      ...
      <Typography variant="h5" sx={{ textAlign: "center", marginBottom: 3 }}>
        <b>Panel Składników Aktywnych</b>
      </Typography>
      <Card>
        <CardHeader
          title={
