...
const BodyOilsTable = () => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(`/api/BodyOils/UpdateBodyOil/${editProduct.Id}`, data)
      .then((response) => {
        fetchProducts();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/BodyOils/RevBodyOil/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/BodyOils/DelBodyOil/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
            ...
            <CardContent>
              <Box>
                <Typography variant="h6" textAlign={"center"} marginBottom={1}>
                  <b>Tabela Produktów Olejowych</b>
                </Typography>
              </Box>
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>
              Nie Znaleziono Produktów Olejowych w Bazie Danych
            </Typography>
          </Box>
        )}
      </div>
