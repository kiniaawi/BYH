...
import BodyExfoliantsTable from "./BodyExfoliantsTable";

const BodyExfoliants = ({ onChangeContent }) => {
  const [cookies, setCookie, removeCookie] = useCookies([
    "emailCookie",
    "currentPageCookie",
  ]);
  setCookie("currentPageCookie", "body-exfoliants", { path: "/" });
  ...
  return (
    <Box p={2} sx={{ height: "300vh" }}>
      ...
      <Typography variant="h5" sx={{ textAlign: "center", marginBottom: 3 }}>
        <b>Panel Produktów Złuszczających</b>
      </Typography>
      <Card>
        <CardHeader
          title={
