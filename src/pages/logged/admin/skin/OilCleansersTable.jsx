...
const OilCleansersTable = () => {
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/OilCleaners/RevOilCl/${selectedProduct}`)
      .then((response) => {
        console.log(selectedProduct);
      })
      .catch((error) => {
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/OilCleaners/DelOilCl/${selectedProduct}`)
      .then((response) => {
        console.log(selectedProduct);
      })
      .catch((error) => {
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>No Oil Cleaners Found in the Database</Typography>
          </Box>
        )}
      </div>
    </Box>
