...
namespace byh_api.Controllers
{
    ...
    public class BodyMoisturizersController : ControllerBase
    {
        ...
        public JsonResult Post(BodyMoisturizers prod)
        {
            ...
            try
            {
                string query = @"INSERT INTO dbo.BodyMoisturizers VALUES(@ProductName, @ProductTypeId, 
        ...
        [HttpPut("UpdateBodyMoisturizer/{Id}")]
        public JsonResult UpdateBodyMoisturizer(BodyMoisturizers prod, int Id)
        {
            Response response = new Response();
        ...
        [HttpPut("DelBodyMoisturizer/{Id}")]
        public JsonResult DelBodyMoisturizer(int Id)
        {
            Response response = new Response();
        ...
        [HttpPut("RevBodyMoisturizer/{Id}")]
        public JsonResult RevBodyMoisturizer(int Id)
        {
            Response response = new Response();
