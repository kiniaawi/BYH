...
namespace byh_api.Controllers
{
    ...
    [ApiController]
    public class BodyActivesController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IWebHostEnvironment _env;

        public BodyActivesController(IConfiguration configuration, IWebHostEnvironment env)
        {
        ...
        public JsonResult Get()
        {
            ...
            try
            {
                string query = @"SELECT * from dbo.BodyActives";
        ...
        [HttpPost]
        public JsonResult Post(BodyActives prod)
        {
            Response response = new Response();
        ...
        [HttpPut("UpdateBodyActive/{Id}")]
        public JsonResult UpdateBodyActive(BodyActives prod, int Id)
        {
            Response response = new Response();
        ...
        [HttpPut("DelBodyActive/{Id}")]
        public JsonResult DelBodyActive(int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.BodyActives SET IsDeleted = 1
        ...
        [HttpPut("RevBodyActive/{Id}")]
        public JsonResult RevBodyActive(int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.BodyActives SET IsDeleted = 0
        ...
        public JsonResult SaveFile()
        {
            ...
            try
            {
                ...
                if (postedFile != null && postedFile.Length > 0)
                {
                    ...
                    var physicalPath = Path.Combine(_env.ContentRootPath, "Photos/BodyActives", filename);
